...
using System.Linq; // use to OerderByDescending;
using System.Runtime.CompilerServices; // to use Compiler Attribute
...
namespace WorkingWithReflection
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            [CoderAttribute("Johnni Rasmussen", "13 September 2019")]
